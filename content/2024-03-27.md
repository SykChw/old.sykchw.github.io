...
![[zonotope1.svg]] 
The name zonotope is derived from _zona_ meaning 'belt' in Latin. Zonotopes are named such as we can trace an uninterrupted path through the parallel vectors that wrap around the figure like a belt.
![[zonotope2.svg]]
...
&& &\langle c_0, \dots, c_m \rangle  && &\langle c^\prime_0, \dots, c^\prime_m \rangle
\end{align*}
$$ 
